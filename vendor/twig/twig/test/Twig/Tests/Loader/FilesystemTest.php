...
class Twig_Tests_Loader_FilesystemTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testPaths($basePath, $cacheKey, $rootPath)
    {
        ...
        $this->assertEquals("path (final)\n", $loader->getSourceContext('index.php')->getCode());
        $this->assertEquals("path (final)\n", $loader->getSourceContext('@__main__/index.php')->getCode());
        $this->assertEquals("named path (final)\n", $loader->getSourceContext('@named/index.php')->getCode());
    }
    ...
    public function testFindTemplateWithCache()
    {
        ...
        // prime the cache for index.php in the named namespace
        $namedSource = $loader->getSourceContext('@named/index.php')->getCode();
        $this->assertEquals("named path\n", $namedSource);

        // get index.php from the main namespace
